...
void gui::ChallengeWin::draw( egn::Window& window )
{
...
void gui::ChallengeWin::set( const std::string& var, std::string value )
{
	//set
}

void gui::ChallengeWin::set( const std::string& var, int value )
{
	//set
}

void gui::ChallengeWin::updateCursor( int value )
{
	m_Cursor += value;
